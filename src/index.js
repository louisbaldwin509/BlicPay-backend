...
import { moncashRouter } from './routes/moncashDeposits.js';
import { natcashManualRouter } from './routes/natcashManualDeposit.js';
...
import { kycDiditRouter } from './routes/kycDidit.js';
...
app.use('/deposits/moncash', moncashRouter);
app.use('/deposits/natcash', natcashManualRouter);
...
app.use('/kyc/didit', kycDiditRouter);
